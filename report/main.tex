...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.92\textwidth]{p1b_curves.png}
  \caption{PageRank value of each node as a function of the damping factor $a$.}
  \label{fig:p1b_curves}
\end{figure}
...
From Figure~\ref{fig:p1b_curves}, the absolute PageRank values change
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{p3a_precision.png}
    \caption{Precision@10 vs latent factors}
    \label{fig:p3a_prec}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{p3a_recall.png}
    \caption{Recall@10 vs latent factors}
    \label{fig:p3a_rec}
  \end{subfigure}
  \caption{Part 3A: Precision@10 and Recall@10 as a function of the
           number of latent factors ($k=10$, 10 runs each).
...
\begin{figure}[H]
  \centering
  \begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{p3b_precision.png}
    \caption{Precision@k vs k}
    \label{fig:p3b_prec}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{p3b_recall.png}
    \caption{Recall@k vs k}
    \label{fig:p3b_rec}
  \end{subfigure}
  \caption{Part 3B: Precision@k and Recall@k as a function of $k$
           (factors=50, 10 runs each). Error bars show $\pm$1 standard
           deviation.}
  \label{fig:p3b}
\end{figure}
